...
Automated progress: [PR #219](https://github.com/Collaboration95/rewind-app/pull/219) fixes the release tar extraction alert #1; [PR #220](https://github.com/Collaboration95/rewind-app/pull/220) fixes the proxy SSRF alert #2. Both await independent review and merge. [PR #221](https://github.com/Collaboration95/rewind-app/pull/221) adds a blob-only preview guard for alert #3; [PR #222](https://github.com/Collaboration95/rewind-app/pull/222) uses descriptor-first hashing for alert #4. [PR #223](https://github.com/Collaboration95/rewind-app/pull/223) applies a tested `uuid@11.1.1` override for the moderate advisory. These are open PRs, not merged fixes. The current lockfile audit and exact-main scan bundle have run.
