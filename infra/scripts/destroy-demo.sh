#!/usr/bin/env bash
# Back up the live Demo host, then hibernate its disposable compute and optional
# public HTTPS distribution through Terraform. This deliberately preserves the
# backup bucket and recovery/audit IAM.
#
